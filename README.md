About intersphinx-registry-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/intersphinx-registry-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/intersphinx-registry-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add intersphinx-registry
# for installing globally
pixi global install intersphinx-registry
```
...
It is possible to list all of the versions of `intersphinx-registry` available on your platform:
...
```
pixi search intersphinx-registry --channel conda-forge
```
